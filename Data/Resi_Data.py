...
image = "https://github.com/shrutib55/Project-3/blob/ee47d43109dfb3de51e26186ab8b655b6e264f51/Data/ReSI-DATA.jpg"
...
if option == 'Graph':
    graph = st.selectbox(
        ...
        ('Select', 'Median Price', 'Average Price', 'Sales vs Listings'))    
...
if option == 'Forecast':
    ...
    def fetch_data():
        df = pd.read_csv(Path("dfw_county_market_tracker.csv"), infer_datetime_format=True)
        return df
